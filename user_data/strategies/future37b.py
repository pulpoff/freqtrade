...
class future37b(IStrategy):
    ...
    leverage_param = IntParameter(1, 8, default=4, space="buy", optimize=True)
        ...
        if self.dp:
            try:
                ...
                informative_1m['major_trend_reversal'] = (
                    ...
                    (informative_1m['macdhist'] >nformative_1m['macdhist'].shift(1) * 1.2) &
    ...
    def trailing_stop_positive_percentage(self, pair: str, *wargs) -> float:
       coin = self.get_coin_from_pair(pair)
       coin_ts = self.get_trailing_stop_for_coin(coin)
