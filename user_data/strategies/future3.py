...
class future3(IStrategy):
    ...
    trailing_stop_positive_offset = 0.242
    ...
    # Buy parameters with ranges around hyperopt results
    buy_rsi = IntParameter(30, 38, default=34, space='buy', optimize=True)  
    buy_adx = IntParameter(18, 26, default=22, space='buy', optimize=True)  
    buy_bb_mult = DecimalParameter(1.01, 1.09, decimals=2, default=1.05, space='buy', optimize=True)
    
    # Sell parameters with ranges around hyperopt results
    sell_rsi = IntParameter(74, 82, default=78, space='sell', optimize=True)  
    sell_adx = IntParameter(22, 30, default=26, space='sell', optimize=True)  
    sell_bb_mult = DecimalParameter(0.95, 1.03, decimals=2, default=0.99, space='sell', optimize=True)
    ...
    def custom_exit(self, pair: str, trade: Trade, current_time: datetime, 
        ...
        # Time-based exits for both directions
