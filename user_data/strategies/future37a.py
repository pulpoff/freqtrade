...
class future37a(IStrategy):
    ...
    leverage_param = IntParameter(1, 8, default=2, space="buy", optimize=True)
    
    buy_rsi = IntParameter(30, 50, default=47, space="buy", optimize=True)
    sell_rsi_upper = IntParameter(65, 80, default=73, space="sell", optimize=True)
    sell_rsi_lower = IntParameter(20, 30, default=25, space="sell", optimize=True)
       ...
       if trade.is_short:
           try:
               ...
               if len(dataframe) > 0:
                   ...
                   if entry_signal_col in last_candle and last_candle[entry_signal_col] > 0:
