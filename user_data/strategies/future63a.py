...
class future63a(IStrategy):
    ...
    leverage_long = IntParameter(4, 12, default=7, space="buy", optimize=True)
    leverage_short = IntParameter(4, 12, default=4, space="sell", optimize=True)
    ...
    def leverage(self, pair: str, current_time: datetime, current_rate: float,
        ...
        if side == 'long':
            return self.leverage_long.value
        else:
            return self.leverage_short.value
