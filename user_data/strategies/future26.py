...
class future26(IStrategy):
    ...
    stoploss = -0.03  # Smaller stoploss
    trailing_stop = True
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe['price_peak'] = (
            ...
            (dataframe['rsi'] > self.rsi_upper.value)                  # RSI overbought
        )
        ...
        dataframe['price_reversal'] = (
            ...
            (dataframe['rsi'] > self.rsi_upper.value * 0.95)                # RSI elevated
        )
        ...
        dataframe['short_entry'] = (
            ...
            (dataframe['rsi'] > self.rsi_upper.value * 0.95)          # RSI must be elevated
        )
