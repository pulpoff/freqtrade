...
class future61(IStrategy):
    ...
    # Leverage
    leverage_long = IntParameter(3, 10, default=6, space="buy", optimize=True)
    leverage_short = IntParameter(3, 10, default=6, space="sell", optimize=True)
